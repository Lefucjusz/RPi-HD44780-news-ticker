...
static gpio_t HD44780_gpio;

static void HD44780_init_gpio(void) {
    /* Set pins as outputs */
    gpio_set_pin_dir(HD44780_gpio, HD44780_config->RS, GPIO_OUTPUT);
    gpio_set_pin_dir(HD44780_gpio, HD44780_config->E, GPIO_OUTPUT);
    gpio_set_pin_dir(HD44780_gpio, HD44780_config->D4, GPIO_OUTPUT);
    gpio_set_pin_dir(HD44780_gpio, HD44780_config->D5, GPIO_OUTPUT);
    gpio_set_pin_dir(HD44780_gpio, HD44780_config->D6, GPIO_OUTPUT);
    gpio_set_pin_dir(HD44780_gpio, HD44780_config->D7, GPIO_OUTPUT);
}
...
void HD44780_write_byte(uint8_t byte, HD44780_mode_t mode) {
	/* Set RS line state */
	gpio_set_pin_state(HD44780_gpio, HD44780_config->RS, mode == HD44780_CHARACTER ? GPIO_HIGH : GPIO_LOW);

	/* Write upper nibble */
	gpio_set_pin_state(HD44780_gpio, HD44780_config->D7, (byte & (1 << 7)) ? GPIO_HIGH : GPIO_LOW);
	gpio_set_pin_state(HD44780_gpio, HD44780_config->D6, (byte & (1 << 6)) ? GPIO_HIGH : GPIO_LOW);
	gpio_set_pin_state(HD44780_gpio, HD44780_config->D5, (byte & (1 << 5)) ? GPIO_HIGH : GPIO_LOW);
	gpio_set_pin_state(HD44780_gpio, HD44780_config->D4, (byte & (1 << 4)) ? GPIO_HIGH : GPIO_LOW);

	/* Pulse enable signal */
	gpio_set_pin_state(HD44780_gpio, HD44780_config->E, GPIO_HIGH);
	usleep(1); // Wait 1us
	gpio_set_pin_state(HD44780_gpio, HD44780_config->E, GPIO_LOW);

	/* Write lower nibble */
	gpio_set_pin_state(HD44780_gpio, HD44780_config->D7, (byte & (1 << 3)) ? GPIO_HIGH : GPIO_LOW);
	gpio_set_pin_state(HD44780_gpio, HD44780_config->D6, (byte & (1 << 2)) ? GPIO_HIGH : GPIO_LOW);
	gpio_set_pin_state(HD44780_gpio, HD44780_config->D5, (byte & (1 << 1)) ? GPIO_HIGH : GPIO_LOW);
	gpio_set_pin_state(HD44780_gpio, HD44780_config->D4, (byte & (1 << 0)) ? GPIO_HIGH : GPIO_LOW);
...
void HD44780_write_integer(int32_t number, uint8_t required_length) {
	...
	snprintf(buffer, HD44780_TMP_BUF_SIZE, "%u", number);
